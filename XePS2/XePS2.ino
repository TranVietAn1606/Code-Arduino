  ...
  if(ps2x.Button(PSB_PAD_UP)){
    ...
    Serial.println("R2"); 
      ...
      if((ps2x.Analog(PSS_RY)) == 127 && ps2x.Analog(PSS_RX) == 128) 
        Serial.println("R3: dung");
      else
       if((ps2x.Analog(PSS_RY)) == 0 && ps2x.Analog(PSS_RX) == 128) 
        ps2 = 1;
      else
       if((ps2x.Analog(PSS_RY)) == 0 && ps2x.Analog(PSS_RX) == 0) 
        ps2 = 5;
      else
       if((ps2x.Analog(PSS_RY)) == 127 && ps2x.Analog(PSS_RX) == 0) 
        ps2 = 3;
      else
       if((ps2x.Analog(PSS_RY)) == 255 && ps2x.Analog(PSS_RX) == 0) 
        ps2 = 8;
      else
       if((ps2x.Analog(PSS_RY)) == 255 && ps2x.Analog(PSS_RX) == 128) 
        ps2 = 2;
      else
       if((ps2x.Analog(PSS_RY)) == 255 && ps2x.Analog(PSS_RX) == 255) 
        ps2 = 7;
      else
       if((ps2x.Analog(PSS_RY)) == 127 && ps2x.Analog(PSS_RX) == 255) 
        ps2 = 4;
      else
       if((ps2x.Analog(PSS_RY)) == 0 && ps2x.Analog(PSS_RX) == 255) 
        ps2 = 6;
    } 
